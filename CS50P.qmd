...
print("Hello world!")
```
This was simple and I am OK with it.

#### Variables

Variables are containers for values or strings we are saving momentarily (unles it can't be modified).  The following code is offered:
...
Asignation takes place with the equal sign.  Here we are also *inputing* a variable...

#### Comments

Comments can be added to the code with the numeral sign.

#### Pseudocode

Pretty nuch comments on what is the program doing... A to do list...
